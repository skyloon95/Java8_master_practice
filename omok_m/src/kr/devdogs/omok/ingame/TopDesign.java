...
public class TopDesign extends JPanel{
	...
	public TopDesign() {
		...
		//	패널 사이즈 설정
		setPreferredSize(new Dimension(Main.TOPBAR_WIDTH,Main.TOPBAR_HEIGHT));
		//	이미지 로드
	...
	public void paint(Graphics graphics) {
		...
		if(mouseOn) {
			g.drawImage(gameStartButtonOn, Main.START_BUTTON_WIDTH, Main.START_BUTTON_HEIGHT, null);
		}
		else
			g.drawImage(gameStartButton, Main.START_BUTTON_WIDTH, Main.START_BUTTON_HEIGHT, null);
	}
